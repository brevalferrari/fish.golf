...
const results = () => {
  ...
  const results_h1 = document.getElementById("results");
  if (color_name.includes("pink")) {
    change_image("img/full-win.png");
  } else if (color_name.includes("black")) {
    change_image("img/full-black.png");
  } else if (color_name.includes("white")) {
    change_image("img/full-retreat.png");
  } else {
    change_image("img/full-draw.png");
  }
  setTimeout(() => {
    jsConfetti.addConfetti({
      emojis: [getRandomEmoji()], // Use the emoji as confetti
      emojiSize: 70,
    ...
    if (color_name.includes("pink")) {
      ...
      results_h1.innerHTML = "EPIC DRAW";
    }
  }, 2000);
};
